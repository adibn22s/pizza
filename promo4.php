...
<img src="img/7.jpg" class="img-fluid mt-4 rounded" width="650" alt="...">
<p class="text-md-start mt-4">Nikmati makan hemat selera ini dengan membeli 4 paket my box gratis 1 my box selama periode berlangsung. Syaratnya mudah hanya melakukan pemesanan melalui website ini saja.</p>
<p class="text-md-start mt-5">Untuk informasi lebih lengkap terkait promo,simak syarat dan ketentuannya berikut ini,yaitu:</p>
    <div class="row">
        <div class="col-md-10 offset-md-2">
            <p class="text-md-start mt-3 lh-1">1. Promo makan selera 4 paket my box dengan menu pilihan tertentu</p>
        ...
        <a href="beli.php?id=60" ><button type="submit" name="selengkapnya" class="btn btn-light border border-dark btn-promo-style btn-group-sm fw-bold ms-5 mt-3" >Pesan</button></a>
    </div>
</div>    
