...
<img src="img/4.png" class="img-fluid mt-4 rounded" width="650" alt="...">
<p class="text-md-start mt-4">Nikmati potongan harga pizza yang penuh cinta ini selama periode berlangsung. Syaratnya mudah hanya melakukan pemesanan melalui website ini saja.</p>
<p class="text-md-start mt-5">Untuk informasi lebih lengkap terkait promo,simak syarat dan ketentuannya berikut ini,yaitu:</p>
    <div class="row">
        <div class="col-md-10 offset-md-2">
            <p class="text-md-start mt-3 lh-1">1. Promo potongan harga pada pizza dengan nama "Pizza Heart"</p>
        ...
        <a href="beli.php?id=61" ><button type="submit" name="selengkapnya" class="btn btn-light border border-dark btn-promo-style btn-group-sm fw-bold ms-5 mt-3" >Pesan</button></a>
    </div>
</div>    
